...
E.g. version `2.0.0` of module `rules_ecu_config` is contained in [modules/rules_ecu_config/2.0.0](modules/rules_ecu_config/2.0.0).
...
- Bazel **8.5.1**
  - **dvarjson** 1.1.0
  - **dvcfg6** 6.2.5
  - **rules_cfg6** [1.0.0, 2.0.0]
  - **rules_dvarjson** [1.0.0, 1.1.0]
  - **rules_ecu_config** [1.0.0, 2.0.0]
