...
```starlark
bazep_dep(name = "rules_cfg6", version = "2.1.0")
```
...
<pre>
load("@rules_cfg6", "archived_project")
...
<pre>
load("@rules_cfg6", "validation_report")
...
<pre>
load("@rules_cfg6", "pipeline_executable")
...
<pre>
load("@rules_cfg6", "run_on_project")
