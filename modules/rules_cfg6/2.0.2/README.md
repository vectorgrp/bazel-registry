...
```starlark
bazep_dep(name = "rules_cfg6", version = "2.0.2")
```
...
| <a id="export_flat_extract-bsw_pkg"></a>bsw_pkg |  The BSW package folder.   | String | required |  |
| <a id="export_flat_extract-dvjson"></a>dvjson |  The .dvjson file.   | String | required |  |
...
| <a id="run_export-bsw_pkg"></a>bsw_pkg |  The BSW package folder.   | String | required |  |
| <a id="run_export-dvjson"></a>dvjson |  The .dvjson file.   | String | required |  |
