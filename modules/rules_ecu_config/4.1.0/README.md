...
# rules_ecu_config v4.1.0

```starlark
bazep_dep(name = "rules_ecu_config", version = "4.1.0")
```
...
ecu_config.project(<a href="#ecu_config.project-name">name</a>, <a href="#ecu_config.project-as_code">as_code</a>, <a href="#ecu_config.project-bsw_pkg">bsw_pkg</a>, <a href="#ecu_config.project-cfg6_defs">cfg6_defs</a>, <a href="#ecu_config.project-diag_modules">diag_modules</a>, <a href="#ecu_config.project-dvjson">dvjson</a>, <a href="#ecu_config.project-evs">evs</a>, <a href="#ecu_config.project-extract">extract</a>, <a href="#ecu_config.project-modules">modules</a>,
...
<pre>
load("@MyProject//:defs.bzl", "eac_jar")

eac_jar(*, <a href="#eac_jar-name">name</a>, <a href="#eac_jar-deps">deps</a>, <a href="#eac_jar-srcs">srcs</a>, <a href="#eac_jar-data">data</a>, <a href="#eac_jar-resources">resources</a>, <a href="#eac_jar-add_exports">add_exports</a>, <a href="#eac_jar-add_opens">add_opens</a>, <a href="#eac_jar-allow_beta">allow_beta</a>, <a href="#eac_jar-arg">arg</a>,
        <a href="#eac_jar-bootclasspath">bootclasspath</a>, <a href="#eac_jar-exported_plugins">exported_plugins</a>, <a href="#eac_jar-exports">exports</a>, <a href="#eac_jar-javabuilder_jvm_flags">javabuilder_jvm_flags</a>, <a href="#eac_jar-javacopts">javacopts</a>, <a href="#eac_jar-licenses">licenses</a>,
        <a href="#eac_jar-neverlink">neverlink</a>, <a href="#eac_jar-plugins">plugins</a>, <a href="#eac_jar-proguard_specs">proguard_specs</a>, <a href="#eac_jar-resource_strip_prefix">resource_strip_prefix</a>, <a href="#eac_jar-runtime_deps">runtime_deps</a>, <a href="#eac_jar-tags">tags</a>, <a href="#eac_jar-visibility">visibility</a>)
</pre>
...
| <a id="eac_jar-deps"></a>deps |  [Inherited rule attribute](https://bazel.build/reference/be/java#java_library)   | <a href="https://bazel.build/concepts/labels">List of labels</a>; <a href="https://bazel.build/reference/be/common-definitions#configurable-attributes">nonconfigurable</a> | optional |  `[]`  |
...
| <a id="eac_jar-allow_beta"></a>allow_beta |  Whether to allow usage of beta PAI APIs.   | Boolean; <a href="https://bazel.build/reference/be/common-definitions#configurable-attributes">nonconfigurable</a> | optional |  `None`  |
...
| <a id="eac_jar-tags"></a>tags |  [Inherited rule attribute](https://bazel.build/reference/be/common-definitions#common-attributes)   | List of strings; <a href="https://bazel.build/reference/be/common-definitions#configurable-attributes">nonconfigurable</a> | optional |  `None`  |
...
<pre>
load("@MyProject//:defs.bzl", "edit_project")
...
<pre>
load("@MyProject//:defs.bzl", "generate_foundation_layer")
...
Macro for generating the foundation layer API sources for `@MyProject//:project`.
...
| <a id="generate_foundation_layer-bsw_pkg"></a>bsw_pkg |  The D:/dev/bazel-regristry/build/davinci/bsw package folder (defaults to the ECU's D:/dev/bazel-regristry/build/davinci/bsw package).   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
<pre>
load("@MyProject//:defs.bzl", "run_on_project")
