...
# rules_dvarjson v1.1.0

```starlark
bazep_dep(name = "rules_dvarjson", version = "1.1.0")
```
...
dvarjson_archive(<a href="#dvarjson_archive-name">name</a>, <a href="#dvarjson_archive-auth_patterns">auth_patterns</a>, <a href="#dvarjson_archive-nupkg_auth_patterns">nupkg_auth_patterns</a>, <a href="#dvarjson_archive-nupkg_sha256">nupkg_sha256</a>, <a href="#dvarjson_archive-nupkg_url">nupkg_url</a>, <a href="#dvarjson_archive-sha256">sha256</a>, <a href="#dvarjson_archive-url">url</a>)
</pre>
...
| <a id="dvarjson_archive-auth_patterns"></a>auth_patterns |  Authorization patterns (see [http_archive](https://bazel.build/rules/lib/repo/http#http_archive-auth_patterns)).   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
| <a id="dvarjson_archive-nupkg_auth_patterns"></a>nupkg_auth_patterns |  Authorization patterns (see [http_archive](https://bazel.build/rules/lib/repo/http#http_archive-auth_patterns)).   | <a href="https://bazel.build/rules/lib/core/dict">Dictionary: String -> String</a> | optional |  `{}`  |
| <a id="dvarjson_archive-nupkg_sha256"></a>nupkg_sha256 |  SHA256 checksum of the .nupkg archive.   | String | optional |  `""`  |
| <a id="dvarjson_archive-nupkg_url"></a>nupkg_url |  URL of the .nupkg archive. Mutually exclusive with `url`.   | String | optional |  `""`  |
| <a id="dvarjson_archive-sha256"></a>sha256 |  SHA256 checksum of the .deb archive.   | String | optional |  `""`  |
| <a id="dvarjson_archive-url"></a>url |  URL of the .deb archive. Mutually exclusive with `nupkg_url`.   | String | optional |  `""`  |
